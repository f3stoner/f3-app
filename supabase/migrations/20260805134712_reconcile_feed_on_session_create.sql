...
begin
    ...
    */
     ...
     *
     * Every successfully created interactive session must
     * produce exactly one session_completed feed event.
     *
     * This runs after participant, inviter, and visitor
     * reconciliation so the event represents the completed
     * canonical session.
     *
     * Updates do not create additional feed events.
     * Historical and batch import paths intentionally bypass
     * this command and therefore do not populate the V1 feed.
     */
    if p_mode = 'create' then
