...
begin
   ...
   /*
    * Canonical members may participate in sessions
    * outside their home region.
    *
    * Session ownership and authorization remain
    * region-scoped, but participant identity is global.
    *
    * Cross-region participants remain external/DR members;
    * this validation does not add them to the regional roster.
    */
    if exists (
        select 1
        from jsonb_array_elements_text(
