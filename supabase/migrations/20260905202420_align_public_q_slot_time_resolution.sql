            ...
            (
                ...
                left join lateral (
                    ...
                    where ars.region_id = v_region_id
                      ...
                      and ars.weekday = extract(dow from qs.date)::integer
                      and ars.is_active = true
                      and (
                          ars.effective_start_date is null
...
revoke all on function public.load_public_region_site(text, date, date) from anon;
revoke all on function public.load_public_region_site(text, date, date) from authenticated;
