...
begin
    ...
    loop
        /*
         * Resolve AO from committed staged structure.
         */
        ...
        /*
         * Resolve every staged participant from the latest durable
         * identity resolution.
         */
        ...
        /*
         * Prevent one canonical member from appearing twice in the
         * same participant role after source identities resolve.
         */
        if exists (
            select 1
        ...
        /*
         * Duplicate detection against live sessions.
         *
         * Production date/start_time are text, so convert the staged
         * typed values to the formats used by current sessions.
         */
        select count(*)
        ...
        where existing.region_id = target_project.region_id
          ...
          and existing.ao_id = resolved_ao_id
          and (
