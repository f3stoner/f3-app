...
begin
    ...
    /*
     * Only review sessions that have not already been committed.
     *
     * Committed staged rows are terminal and must not be pushed
     * back through duplicate detection, because the production
     * session they find may be the session this import created.
     */
