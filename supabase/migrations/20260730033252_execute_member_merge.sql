...
comment on function public.execute_member_merge(
    ...
    'Executes an approved clean member merge using its stored deterministic manifest, rebuilds regional member_stats, retires the duplicate, and verifies postconditions. Superadmin only.';
