...
begin
    ...
    /*
     * Public Q Sites are production-only.
     *
     * is_enabled controls whether a production region has a
     * published site. environment controls whether the region
     * is eligible to exist on the public surface at all.
     */
    select r.id
    into v_region_id
